        ...
        <main class="main">
            <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <div class="post__content">
                        ...
                        <div class="post-additional-info">
                            ...
                            <span class="category">
                                ...
                                <a href="{{ route('main.category',['id' => $post->category->id]) }}">{{$post->category->name}}</a>
                            </span>
                ...
                <div class="pagination-arrow">
                	...
                	@if($prev_post)
                		<a href="{{ route('main.single-post',['slug' => $prev_post->slug]) }}" class="btn-prev-wrap">
	                        <svg class="btn-prev">
					...
					@if($next_post)
	                     <a href="{{ route('main.single-post', ['slug' => $next_post->slug]) }}" class="btn-next-wrap">
	                        <div class="btn-content">
